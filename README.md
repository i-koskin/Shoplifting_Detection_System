# 👁️‍🗨️  Система детекции подозрительного поведения (скрытия товара в магазине)
...
- реализовал модуль по автоматической разметке изображений на основании подготовленных видеофайлов  с нормальным и подозрительным поведением человека;
- дополнительно обучил модель YOLO-pose для детекции  подозрительного поведения для каждой камеры:
   - *cam1: Accuracy: 0.9747, ROC-AUC: 0.9937;*
   - *cam2: Accuracy: 0.9795, ROC-AUC: 0.9966;*
   - *cam3: Accuracy: 0.9774, ROC-AUC: 0.9932;*
- для классификации результатов детекции использовал модель XGBoost Classifier;
- разработал функционал для сохранения изображений и видеофайлов при срабатывании;
- разработал гибкую систему логирования.
  
## 📸 Примеры работы

| *Обработанное изображение* | *Цветовая кодировка поведения* |
|-|-|
| <img src="./assets/out_cam2_1.jpg" width="1200"> | 🟢 Зеленый - *нормальное поведение* |
| <img src="./assets/out_cam2_2.jpg" width="1200"> | 🟠 Оранжевый - *потенциально подозрительное (в процессе валидации)* |
| <img src="./assets/out_cam2_3.jpg" width="1200"> | 🔴 Красный - *подтвержденное подозрительное поведение* |
